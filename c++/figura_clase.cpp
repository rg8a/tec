...
// Este programa crea y manipula las clases Figura, Cuadrado, Triangulo, Circulo Y PENTAGONO en relacion de herencia, 
...
Pentagono::Pentagono(int _lado, string _colorFigura, float _radio):Figura(numLados, _colorFigura){
    radio = _radio;
    lado = _lado;
}

void Pentagono::muestraDatos(){
    cout << endl << "Figura Pentágono: " << endl;
    cout << "Radio: " << radio << endl;
    cout << "Color: " << colorFigura << endl;
}

void Pentagono::calculaArea(){
    cout << endl << "El área del Pentágono es: " << (((5 * lado)* radio)/2) << " m^2" << endl;
}
